...
Module({
    ...
    if (match[1]) {
        if (isNumeric(match[1])) {
            ...
            await message.sendMessage(`_Removing all numbers starting with ${match[1]}. You have 10 seconds left to think. *To stop this process, use . shutdown or .leave*_`)
